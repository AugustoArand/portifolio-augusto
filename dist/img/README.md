...
- `mapty.PNG` - Screenshot do app de atividades físicas
- `qr-code.PNG` - Screenshot do gerador de QR Code
- `riot-games-convention.PNG` - Screenshot da página de evento
...
- `excel+powerbi.png` - Logo Excel + PowerBI
- `cypress.png` - Logo Cypress
- `robot-framework.png` - Logo Robot Framework
- `jira.jpg` - Logo Jira & Zephyr
- `postman.png` - Logo Postman
- `jmeter.png` - Logo JMeter
- `scrumstudy.png` - Logo Scrum Study
- `react-next.png` - Logo React + Next.js
...
- Formato WebP será implementado futuramente para melhor performance
